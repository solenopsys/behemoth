...
const valkey_vendor_dir = "../../wrappers/dbs/valkey/vendor/valkey";
const valkey_wrapper_dir = "../../wrappers/dbs/valkey";

fn supportsTransport(target: Build.ResolvedTarget) bool {
    return target.result.os.tag == .linux;
}

const transport_vendor_src = "../../libs/transport/vendor/capnproto/c++/src";
...
fn linkValkeyWrapper(
    ...
    const target_str = build_utils.getTargetString(target);
    const install_dir = b.fmt("../../../apps/behemoth/.zig-cache/valkey-wrapper/{s}", .{target_str});
    ...
    compile.root_module.addIncludePath(b.path("../../wrappers/dbs/valkey/include"));
...
fn buildMdbx(b: *Build, target: Build.ResolvedTarget, optimize: OptimizeMode) *Build.Step.Compile {
    ...
    mdbx.root_module.addCSourceFile(.{
        .file = b.path("../../wrappers/dbs/lmdbx/vendor/libmdbx/src/alloy.c"),
        .flags = flags,
    });
    mdbx.root_module.addCSourceFile(.{
        .file = b.path("../../wrappers/dbs/lmdbx/version.c"),
        .flags = flags,
    });
    mdbx.root_module.addCSourceFile(.{
        .file = b.path("../../wrappers/dbs/lmdbx/cpu_stub.c"),
        .flags = &[_][]const u8{"-fPIC"},
    });
    mdbx.root_module.addIncludePath(b.path("../../wrappers/dbs/lmdbx/vendor/libmdbx"));
    mdbx.root_module.addIncludePath(b.path("../../wrappers/dbs/lmdbx/vendor/libmdbx/src"));
...
fn addSqliteVecObj(b: *Build, target: Build.ResolvedTarget, optimize: OptimizeMode) *Build.Step.Compile {
    ...
    vec.root_module.addCSourceFile(.{
        .file = b.path("../../wrappers/dbs/sqlite-vec/vendor/sqlite-vec/sqlite-vec.c"),
        .flags = flags,
    });
    vec.root_module.addIncludePath(b.path("../../wrappers/dbs/sqlite-vec/vendor/sqlite-vec"));
    vec.root_module.addIncludePath(b.path("../../wrappers/dbs/sqlite-vec/vendor/sqlite-vec/vendor"));
...
fn addStorageExecutable(
    ...
    exe.root_module.addIncludePath(b.path("../../wrappers/dbs/sqlite-vec/vendor/sqlite-vec"));

    exe.root_module.addCSourceFile(.{
        .file = b.path("../../wrappers/dbs/column/src/sqlite3/c/result-transient.c"),
        .flags = &[_][]const u8{"-std=c99"},
    });
    exe.root_module.addIncludePath(b.path("../../wrappers/dbs/column/src/sqlite3/c"));
    exe.root_module.addIncludePath(b.path(sqlite_dir));

    const stanchion_mod = b.createModule(.{
        .root_source_file = b.path("../../wrappers/dbs/column/src/main.zig"),
        .target = target,
        .optimize = optimize,
    });
    stanchion_mod.addIncludePath(b.path("../../wrappers/dbs/column/src/sqlite3/c"));
    ...
    exe.root_module.addImport("lmdbx", b.createModule(.{
        .root_source_file = b.path("../../wrappers/dbs/lmdbx/src/lmdbx.zig"),
        .target = target,
        .optimize = optimize,
    }));

    exe.root_module.addImport("lmdbx_pure", b.createModule(.{
        .root_source_file = b.path("../../wrappers/dbs/lmdbx/src/lmdbx_pure.zig"),
        .target = target,
        .optimize = optimize,
    }));

    exe.root_module.addImport("sqlite3", b.createModule(.{
        .root_source_file = b.path("../../wrappers/dbs/column/src/sqlite3.zig"),
        .target = target,
        .optimize = optimize,
    }));
    ...
    if (with_transport) {
        ...
        exe.root_module.addCSourceFile(.{
            .file = b.path("../../libs/transport/src/storage/generated/wire.capnp.cpp"),
            .flags = cpp_flags,
        });
        exe.root_module.addCSourceFile(.{
            .file = b.path("../../libs/transport/src/storage/capnp_wrap.cpp"),
            .flags = cpp_flags,
        });
        exe.root_module.addIncludePath(b.path("../../libs/transport/include"));
        exe.root_module.addIncludePath(b.path("../../libs/transport/src/storage/generated"));
...
pub fn build(b: *Build) void {
    ...
    tests.root_module.addIncludePath(b.path("../../wrappers/dbs/sqlite-vec/vendor/sqlite-vec"));

    tests.root_module.addCSourceFile(.{
        .file = b.path("../../wrappers/dbs/column/src/sqlite3/c/result-transient.c"),
        .flags = &[_][]const u8{"-std=c99"},
    });
    tests.root_module.addIncludePath(b.path("../../wrappers/dbs/column/src/sqlite3/c"));
    ...
    tests.root_module.addIncludePath(b.path("../../wrappers/dbs/valkey/include"));
